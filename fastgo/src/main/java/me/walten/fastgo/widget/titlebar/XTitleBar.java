package me.walten.fastgo.widget.titlebar;
...
public class XTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        PADDING_5 = InsideScreenUtils.dp2PxInt(context, 5);
        PADDING_12 = InsideScreenUtils.dp2PxInt(context, 12);
        ...
        bottomShadowHeight = array.getDimension(R.styleable.XTitleBar_bottomShadowHeight, InsideScreenUtils.dp2PxInt(context, 0));
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            leftTextSize = array.getDimension(R.styleable.XTitleBar_leftTextSize, InsideScreenUtils.dp2PxInt(context, 16));
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            rightTextSize = array.getDimension(R.styleable.XTitleBar_rightTextSize, InsideScreenUtils.dp2PxInt(context, 16));
        ...
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            centerTextSize = array.getDimension(R.styleable.XTitleBar_centerTextSize, InsideScreenUtils.dp2PxInt(context, 18));
            ...
            centerSubTextSize = array.getDimension(R.styleable.XTitleBar_centerSubTextSize, InsideScreenUtils.dp2PxInt(context, 11));
    ...
    private void initGlobalViews(Context context) {
        ...
        // 计算主布局高度
        if (showBottomLine) {
            mainParams.height = titleBarHeight - Math.max(1, InsideScreenUtils.dp2PxInt(context, 0.4f));
        } else {
        ...
        if (showBottomLine) {
            ...
            LayoutParams bottomLineParams = new LayoutParams(MATCH_PARENT, Math.max(1, InsideScreenUtils.dp2PxInt(context, 0.4f)));
            ...
            LayoutParams bottomShadowParams = new LayoutParams(MATCH_PARENT, InsideScreenUtils.dp2PxInt(context, bottomShadowHeight));
    ...
    private void initMainCenterViews(Context context) {
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            // 设置跑马灯效果
            tvCenter.setMaxWidth((int) (InsideScreenUtils.getScreenPixelSize(context)[0] * 3 / 5.0));
            ...
            int progressWidth = InsideScreenUtils.dp2PxInt(context, 18);
            ...
            // 设置边距
            centerParams.topMargin = InsideScreenUtils.dp2PxInt(context, 7);
            centerParams.bottomMargin = InsideScreenUtils.dp2PxInt(context, 7);
            ...
            int searchIconWidth = InsideScreenUtils.dp2PxInt(context, 15);
            ...
            etSearchHint.setTextSize(TypedValue.COMPLEX_UNIT_PX, InsideScreenUtils.dp2PxInt(context, 14));
...
//    }
    ...
    public void showSoftInputKeyboard(boolean show) {
        if (centerSearchEdiable && show) {
            ...
            InsideScreenUtils.showSoftInputKeyBoard(getContext(), etSearchHint);
        } else {
            InsideScreenUtils.hideSoftInputKeyBoard(getContext(), etSearchHint);
        }
    }
